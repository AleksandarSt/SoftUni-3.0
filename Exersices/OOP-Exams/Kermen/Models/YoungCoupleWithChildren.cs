...
namespace Kermen
{
    public class YoungCoupleWithChildren : YoungCouple
    {
        ...
        public YoungCoupleWithChildren(decimal salaryOne, decimal salaryTwo, decimal tvCost, decimal fridgeCost,
            decimal laptopCost, Child[] children)
        ...
        public override int Population => base.Population + children.Length;
    }
}